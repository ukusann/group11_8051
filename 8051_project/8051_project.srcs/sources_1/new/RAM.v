...
module RAM(clk, rst, wr, rd,direct, addr, data_bus, A, P0, SP, TMOD, DPL, DPH, TL0, TL1, TH0, TH1, IE, IP, PSW, TCON, Rn);   

    input wire clk;            // sysclock
    ...
    output wire [7:0]Rn[0:7];

 
 reg [7:0] data [  0:`DATA_LEN];
  
 reg [7:0] SFR  [128:`DATA_LEN +1];
